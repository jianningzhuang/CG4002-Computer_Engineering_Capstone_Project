...
class PlayerStateBase:
    def __init__(self):
        ...
        self.shield_start_time = time.time() - 30 #updated to time.time() when shield activated
    ...
    def initialize_from_player_state(self, player_state): #edited player_state attributes, but this function useless?
        self.hp             = player_state.hp
        self.action         = player_state.action
