...
# Constants for Beetle/Bluetooth
#############################################################################
...
# --MAC ADDRESSES--
P1_BTL_GUN = "D0:39:72:BF:C1:E4"  # GUN
P1_BTL_VEST = "D0:39:72:BF:C1:D9"  # VEST
P1_BTL_IMU = "D0:39:72:BF:BF:A4"  # MOTION

P2_BTL_GUN = "D0:39:72:BF:BF:CE"  # GUN
P2_BTL_VEST = "D0:39:72:BF:CA:94"  # VEST
P2_BTL_IMU = "D0:39:72:BF:CD:17"  # IMU
...
class NotificationDelegate(DefaultDelegate):
        ...
        try:
            ...
            if raw_packet[0] == 65:
                ...
                message = [BTL_TYPE[self.macAddress] +
                           PLAYER, "BTL->LAPTOP ACK received"]
                print(message)
    ...
    def process_IR_data(self, raw_packet):
        try:
            ...
            # just push sensor data dict onto sensor_data_queue, see dictionary format
            if raw_packet[0] == 71:  # GUN
                gun_data_dict = dict()
                ...
                print(gun_data_dict)
            if raw_packet[0] == 86:  # VEST1637937163
                vest_data_dict = dict()
    ...
    def process_motion_data(self, raw_packet):
        try:
            ...
            COUNT_GOOD_PKT[self.macAddress] += 1
            # print('MOTION PKTS:', COUNT_GOOD_PKT)
            ...
            # print("Q SIZE:", sensor_data_queue_from_beetle.qsize())
        ...
        try:
            while not BTL_HANDSHAKE_STATUS[self.peripheral_obj_beetle.addr]:
                ...
                print("H #{} sent to".format(timeout_count),
                      BTL_TYPE[self.peripheral_obj_beetle.addr] + PLAYER)
        ...
        while not global_shutdown.is_set():
            try:
                ...
                if updated_game_state['updated'] == True:
                    ...
                    if isinstance(updated_game_state["p1"], str):
                        if updated_game_state["p1"] == "logout" or updated_game_state["p2"] == "logout":
                            global_shutdown.set()
...
if __name__ == '__main__':
    ...
    BTL_HANDSHAKE_STATUS = {BTL_GUN: False, BTL_VEST: False, BTL_IMU: False}
    ACK_HANDSHAKE_SENT_flag = {BTL_GUN: False, BTL_VEST: False, BTL_IMU: False}
    ...
    sensor_data_queue_from_beetle.put(
        {'player_num': PLAYER, 'data_type': 'GUN', 'data_value': 1})
    sensor_data_queue_from_beetle.put(
        {'player_num': PLAYER, 'data_type': 'VEST', 'data_value': 1})
