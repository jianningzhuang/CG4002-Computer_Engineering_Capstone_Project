...
P1_BTL_VEST = "D0:39:72:BF:C1:D9"
P1_BTL_IMU = "D0:39:72:BF:BF:A4"

P2_BTL_GUN = "D0:39:72:BF:BF:CE"
P2_BTL_VEST = "D0:39:72:BF:CA:94"
P2_BTL_IMU = "D0:39:72:BF:CD:17"
...
class RelayLaptopClient(threading.Thread):
    ...
    def add_timeout_data_dict(self):
        ...
        timeout_data_dict['data_type'] = 'IMU'
        timeout_data_dict['data_value'] = [
            self.IMU_VALUE, self.IMU_VALUE, self.IMU_VALUE]
        sensor_data_queue_from_beetle.put(timeout_data_dict)
        if self.IMU_VALUE == 0:
            action_start_time = time.time()
            print("start of action: ", action_start_time)
        if self.IMU_VALUE == 120:
            action_end_time = time.time()
            print("end of action: ", action_end_time)
        self.IMU_VALUE = (self.IMU_VALUE + 5) % 125
